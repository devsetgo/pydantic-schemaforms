...
from .base import FormInput, build_label, build_error_message, build_help_text
...
class DatetimeInput(FormInput):
    ...
    def render(self, auto_set_current: bool = False, with_set_now_button: bool = False, **kwargs) -> str:
...
class DateRangeInput:
    ...
    def render(self, name: str, start_label: str = "Start Date", end_label: str = "End Date",
               start_value: Optional[Union[str, date]] = None,
               end_value: Optional[Union[str, date]] = None, **kwargs) -> str:
...
class TimeRangeInput:
    ...
    def render(self, name: str, start_label: str = "Start Time", end_label: str = "End Time",
               start_value: Optional[Union[str, time]] = None,
               end_value: Optional[Union[str, time]] = None, **kwargs) -> str:
