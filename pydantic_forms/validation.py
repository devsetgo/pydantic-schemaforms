...
class DateRangeRule(ValidationRule):
    ...
    def __init__(self, min_date: Optional[Union[date, str]] = None, 
...
class CustomRule(ValidationRule):
    ...
    def __init__(self, validator_func: Callable[[Any], Union[bool, Tuple[bool, str]]], 
                 message: str = "Invalid value", client_side: bool = False):
...
class FieldValidator:
    ...
    def numeric_range(self, min_val: float = None, max_val: float = None, 
                     message: str = None) -> 'FieldValidator':
        """Add numeric range validation."""
        return self.add_rule(NumericRangeRule(min_val, max_val, message))
    
    def date_range(self, min_date: Union[date, str] = None, 
                   max_date: Union[date, str] = None, message: str = None) -> 'FieldValidator':
...
class FormValidator:
    ...
    def validate_pydantic_model(self, model_class: type, data: Dict[str, Any]) -> Tuple[bool, Dict[str, List[str]]]:
        """
...
class CrossFieldRules:
    ...
    @staticmethod
    def password_confirmation(password_field: str = "password", 
                            confirm_field: str = "confirm_password",
                            message: str = "Passwords do not match") -> Callable:
    ...
    @staticmethod
    def date_range_validation(start_field: str, end_field: str,
                             message: str = "End date must be after start date") -> Callable:
