...
from pydantic_forms.integration import (
    FlaskIntegration, FastAPIIntegration, DjangoIntegration,
    ReactJSONSchemaIntegration, VueFormulateIntegration,
...
class TestFastAPIIntegration:
    ...
    def test_fastapi_endpoint_creation(self, simple_form_model):
        ...
        endpoint_func = integration.create_endpoint(
            mock_app,
            '/submit-form',
            simple_form_model
        )
...
class TestDjangoIntegration:
    ...
    def test_django_model_form_creation(self, simple_form_model):
        ...
        with patch('django.forms.ModelForm') as mock_model_form:
            model_form = integration.create_model_form(
                simple_form_model, 
                mock_model
            )
