...
class TextInput(FormInput):
    ...
    def render(self, **kwargs) -> str:
        """Render text input using Python 3.14 template strings."""
...
class TextArea(FormInput):
    ...
    def render(self, **kwargs) -> str:
        """Render textarea using Python 3.14 template strings."""
        ...
        # Use Python 3.14 template string literal and render it
        template = t'<textarea {attributes_str}>{value}</textarea>'
        return render_template(template)
