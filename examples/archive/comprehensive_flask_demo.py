...
class UserProfileModel(BaseModel):
    ...
    # Account Settings
    username: str = Field(
        ..., min_length=3, max_length=30, pattern=r"^[a-zA-Z0-9_]+$", description="Username"
    )
...
def handle_form_submission(form_model, success_message="Form submitted successfully!"):
    ...
    try:
        ...
        if "datetime_field" in form_data and form_data["datetime_field"]:
            form_data["datetime_field"] = datetime.strptime(
                form_data["datetime_field"], "%Y-%m-%dT%H:%M"
            )
    ...
    return {
        ...
        "contact": [
            ...
            },
            {
                ...
                "help": "Minimum 10 characters, maximum 2000",
            },
