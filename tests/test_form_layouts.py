...
class TestFormLayoutBasePrivateMethods:
    ...
    def test_render_form_instances_with_data(self):
        ...
        rendered = layout._render_form_instances(data=data, errors=errors, framework='bootstrap')
    ...
    def test_render_form_instances_material_framework(self):
        ...
        layout = TestVerticalLayout()
        rendered = layout._render_form_instances(data=None, errors=None, framework='material')
...
class TestListLayoutRendering:
    ...
    def test_render_collapsible_item_bootstrap(self):
        ...
        layout = ListLayout(
            form_model=TaskForm, min_items=0, collapsible_items=True, items_expanded_by_default=True
        )
    ...
    def test_render_add_button_bootstrap(self):
        ...
        layout = ListLayout(form_model=TaskForm, min_items=0, add_button_text='Add New Item')
    ...
    def test_render_add_button_material(self):
        ...
        layout = ListLayout(form_model=TaskForm, min_items=0, add_button_text='Add Task')
    ...
    def test_render_remove_button_bootstrap(self):
        ...
        layout = ListLayout(form_model=TaskForm, min_items=0, remove_button_text='Delete')
    ...
    def test_render_remove_button_material(self):
        ...
        layout = ListLayout(form_model=TaskForm, min_items=0, remove_button_text='Remove Item')
    ...
    def _create_mock_renderer(self):
        ...
        class MockRenderer:
            def render_form_from_model(
                self, model, framework='bootstrap', include_submit_button=True
            ):
