...
class HorizontalLayout:
    ...
    template = t(
        """<div style="display:flex; flex-direction: row;{style}" class="{class_}">{content}</div>"""
    )
...
class VerticalLayout:
    ...
    template = t(
        """<div style="display:flex; flex-direction: column;{style}" class="{class_}">{content}</div>"""
    )
...
class GridLayout:
    ...
    template = t(
        """<div style="display:grid; grid-template-columns: {columns};{style}" class="{class_}">{content}</div>"""
    )
...
if __name__ == "__main__":
    ...
    print(
        ssn_input.render(
            name="ssn", id_="ssn", class_="form-control", style="", required="", value="123-45-6789"
        )
    )
    ...
    print(
        horizontal_layout.render(
            content="Column 1 | Column 2 | Column 3", style="justify-content: space-between;"
        )
    )

    vertical_layout = VerticalLayout()
    print(
        vertical_layout.render(content="Row 1<br>Row 2<br>Row 3", style="align-items: flex-start;")
    )

    grid_layout = GridLayout()
    print(
        grid_layout.render(
            content="Item 1|Item 2|Item 3|Item 4", columns="1fr 1fr 1fr 1fr", style="gap: 10px;"
        )
    )
    ...
    print(
        tab_layout.render(
            tabs='<div class="tab" onclick="openTab(event, \'Tab1\')">Tab 1</div><div class="tab" onclick="openTab(event, \'Tab2\')">Tab 2</div>',
            class_="custom-tabs",
            style="",
        )
    )
    ...
    print(
        accordion_layout.render(
            sections='<div class="section" onclick="toggleSection(this)">Section 1</div><div class="section-content">Content 1</div><div class="section" onclick="toggleSection(this)">Section 2</div><div class="section-content">Content 2</div>',
    ...
    print(
        modal_layout.render(
            content="This is a modal", modal_id="myModal", class_="fade", style="display:none;"
        )
    )

    sidebar_layout = SidebarLayout()
    print(
        sidebar_layout.render(
            content="Sidebar content here", class_="custom-sidebar", style="width:250px;"
        )
    )
