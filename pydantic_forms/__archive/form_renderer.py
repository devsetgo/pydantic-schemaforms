...
def create_demo_form() -> FormDefinition:
    ...
    fields = [
        ...
        FormField(
            "password", "password", "Password", required=True, placeholder="Enter your password"
        ),
        FormField(
            "biography",
            "textarea",
        ...
        FormField(
            "birthday", "date", "Birthday", min="1900-01-01", max="2100-12-31", value="2000-01-01"
        ),
        FormField(
            "event_time",
            "datetime",
        ...
        FormField(
            "resume", "file", "Resume", required=True, accept=".pdf,.docx", multiple="multiple"
        ),
        ...
        FormField(
            "ccn", "credit_card", "Credit Card Number", pattern=r"\d{16}", value="1234567812345678"
        ),
    ]

    return FormDefinition(title="Demo Form", fields=fields, submit_url="/submit")
