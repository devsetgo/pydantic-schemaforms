...
from pydantic_forms.layouts import (
    HorizontalLayout, VerticalLayout, GridLayout, ResponsiveGridLayout,
    TabLayout, AccordionLayout, ModalLayout, CardLayout, 
    BaseLayout, LayoutFactory, Layout
)
...
class TestLayoutIntegration:
    ...
    def test_tabs_with_different_layout_content(self):
        ...
        grid_content = GridLayout(["Item 1", "Item 2", "Item 3", "Item 4"], columns="1fr 1fr").render()
