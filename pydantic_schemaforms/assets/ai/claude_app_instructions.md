<!-- GENERATED FILE -- do not edit directly. Source: _shared_instructions.md + _profile_claude.md. Regenerate with `make ai-instructions` (scripts/build_ai_instructions.py). -->
